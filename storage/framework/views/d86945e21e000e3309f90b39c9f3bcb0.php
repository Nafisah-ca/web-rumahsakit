...
<section class="py-14 bg-white">
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="card-base overflow-hidden relative <?php echo e($p['best'] ? 'ring-2 ring-purple-500' : ''); ?> fade-up">
                <?php if($p['best']): ?>
                <div class="absolute top-0 left-0 right-0 text-center bg-purple-600 text-white text-xs font-bold py-1 tracking-wider">
                    ⭐ TERPOPULER
                </div>
                <?php endif; ?>
                <div class="p-6 <?php echo e($p['best'] ? 'pt-10' : ''); ?>">
                    <div class="w-12 h-12 rounded-xl bg-<?php echo e($p['color']); ?>-100 flex items-center justify-center mb-4">
                        <i class="fas <?php echo e($p['icon']); ?> text-<?php echo e($p['color']); ?>-600 text-xl"></i>
                    </div>
                    <h3 class="font-extrabold text-gray-900 text-xl mb-1"><?php echo e($p['nama']); ?></h3>
                    <div class="text-2xl font-black text-<?php echo e($p['color']); ?>-600 mb-5"><?php echo e($p['harga']); ?></div>
                    <ul class="space-y-2 mb-6">
                        ...
                        <li class="flex items-start gap-2 text-sm text-gray-600">
                            <i class="fas fa-check-circle text-<?php echo e($p['color']); ?>-500 mt-0.5 flex-shrink-0 text-xs"></i>
                            <?php echo e($item); ?>

                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <a href="<?php echo e(route('portal.booking.create')); ?>" class="block w-full text-center py-2.5 rounded-xl font-bold text-sm transition-all
                        <?php echo e($p['best'] ? 'bg-purple-600 text-white hover:bg-purple-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="rounded-2xl p-8 md:p-12 text-center" style="background: linear-gradient(135deg, #1e3a5f, #0f4c81);">
            ...
            <div class="flex flex-wrap gap-3 justify-center">
                <a href="<?php echo e(route('portal.booking.create')); ?>" class="flex items-center gap-2 bg-white text-blue-800 px-6 py-3 rounded-xl font-bold text-sm hover:bg-blue-50 transition-all shadow-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\web-rumahsakit\web-rumahsakit\resources\views/mcu.blade.php ENDPATH**/ ?>