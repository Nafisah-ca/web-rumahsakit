    ...
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div id="antrian-content">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                ?>
                <?php $__currentLoopData = $poliklinik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-<?php echo e($p['color']); ?>-100 flex items-center justify-center flex-shrink-0">
                                <i class="fas <?php echo e($p['icon']); ?> text-<?php echo e($p['color']); ?>-600 text-sm"></i>
                            </div>
                            <h3 class="font-bold text-gray-900 text-sm"><?php echo e($p['nama']); ?></h3>
                        </div>
                        <span class="text-xs font-bold px-2 py-0.5 rounded-full <?php echo e($p['status']==='Buka' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
                            <?php echo e($p['status']); ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div class="bg-gray-50 rounded-xl p-3 text-center">
                            <div class="text-2xl font-black text-green-700"><?php echo e($p['antrian']); ?></div>
                            <div class="text-xs text-gray-500 font-medium">Total Antrian</div>
                        </div>
                        <div class="bg-green-50 rounded-xl p-3 text-center">
                            <div class="text-2xl font-black text-green-600"><?php echo e($p['dipanggil']); ?></div>
                    ...
                    <div class="flex items-center gap-2 text-xs text-gray-500 bg-yellow-50 rounded-lg px-3 py-2 border border-yellow-100">
                        ...
                        <span>Estimasi tunggu: <strong class="text-yellow-700"><?php echo e($p['estimasi']); ?></strong></span>
                    </div>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\rumahsakit\resources\views/live-antrian.blade.php ENDPATH**/ ?>