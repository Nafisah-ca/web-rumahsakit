    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-2xl flex items-start gap-3">
            ...
            <div>
                ...
                <a href="<?php echo e(route('portal.profil')); ?>" class="inline-flex items-center gap-1 mt-2 text-sm font-bold text-amber-700 underline">
                    Lengkapi Profil →
                </a>
            </div>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('portal.booking.store')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div>
                    ...
                    <select name="dokter_id" id="dokter_id"
                        ...
                        <option value="<?php echo e($d->id); ?>" <?php echo e((old('dokter_id', $dokter?->id) == $d->id) ? 'selected' : ''); ?>>
                            <?php echo e($d->nama_dokter); ?> — <?php echo e($d->spesialisasi?->nama_spesialis); ?>
                    ...
                    <?php if($dokter): ?>
                    <input type="hidden" name="dokter_id" value="<?php echo e($dokter->id); ?>">
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan"
                        min="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e(old('tanggal_kunjungan', date('Y-m-d'))); ?>"
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="keluhan" rows="3" required
                            ...
                            placeholder="Deskripsikan keluhan Anda secara singkat..."><?php echo e(old('keluhan')); ?></textarea>
            ...
            <div class="bg-green-50 border border-green-200 rounded-2xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <p class="font-bold text-green-900"><?php echo e($pasien->nama_lengkap); ?></p>
                <p class="text-green-700 text-xs">No. RM: <?php echo e($pasien->no_rm ?? '-'); ?> &nbsp;|&nbsp; <?php echo e($pasien->jenis_kelamin_label); ?> &nbsp;|&nbsp; <?php echo e($pasien->user?->no_hp ?? '-'); ?></p>
                </div>
                <a href="<?php echo e(route('portal.profil')); ?>" class="text-green-600 hover:text-green-800 text-xs font-bold">Edit Profil</a>
            </div>
            <?php endif; ?>

            <div class="flex items-center gap-4">
                <button type="submit" <?php echo e(!$pasien ? 'disabled' : ''); ?>
                ...
                <a href="<?php echo e(route('portal.booking.riwayat')); ?>" class="px-6 py-4 rounded-2xl border border-gray-200 text-gray-600 font-bold text-sm hover:bg-gray-50 transition-all">
                    Riwayat
                </a>
            </div>
        </form>
...
function loadJadwal() {
    ...
    const tanggal  = tglInput ? tglInput.value : '<?php echo e(date("Y-m-d")); ?>';
    ...
    fetch(`<?php echo e(route('portal.booking.jadwal')); ?>?dokter_id=${dokterId}&tanggal_kunjungan=${tanggal}`)
        .then(r => r.json())
        .then(data => {
            if (!data.length) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\rumahsakit\resources\views/portal/booking/create.blade.php ENDPATH**/ ?>