...
<div class="hero-slider">
    ...
    <div class="slide" <?php if($banner->gambar): ?> style="background-image: url('<?php echo e(Storage::url($banner->gambar)); ?>'); background-size: cover; background-position: center;" <?php endif; ?>>
        <div style="<?php echo e($gradients[$i % count($gradients)]); ?>; height:100%;"></div>
            ...
            <div class="max-w-screen-xl mx-auto px-6 w-full">
                <div class="max-w-xl">
                    <span class="inline-block bg-white/20 border border-white/30 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-widest backdrop-blur-sm">
                        <?php echo e($setting_global->nama_rumahsakit ?? 'RS Sari Sehat'); ?>

                    </span>
                    <h1 class="text-white font-black text-4xl md:text-5xl leading-tight mb-4">
                        <?php echo nl2br(e($banner->judul)); ?>

                    </h1>
                    <?php if($banner->deskripsi): ?>
                    <p class="text-green-100 text-base mb-7 leading-relaxed max-w-md">
                        <?php echo e($banner->deskripsi); ?>

                    </p>
                    <?php endif; ?>
                    <div class="flex flex-wrap gap-3">
                        <a href="<?php echo e(route('dokter')); ?>" class="flex items-center gap-2 bg-white text-green-700 px-6 py-3 rounded-xl font-bold text-sm shadow-xl hover:bg-green-50 transition-all hover:-translate-y-0.5">
                            <i class="fas fa-calendar-check"></i> Daftar Poliklinik
                        </a>
                        <a href="<?php echo e(route('layanan')); ?>" class="flex items-center gap-2 border-2 border-white/60 hover:border-white text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all hover:-translate-y-0.5 backdrop-blur-sm">
        ...
        <div class="slide-content">
            <div class="max-w-screen-xl mx-auto px-6 w-full">
                <div class="max-w-xl">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="<?php echo e(route('dokter')); ?>" class="flex items-center gap-2 bg-white text-green-700 px-6 py-3 rounded-xl font-bold text-sm shadow-xl hover:bg-green-50 transition-all">
                            <i class="fas fa-calendar-check"></i> Daftar Poliklinik
                        </a>
                    </div>
                </div>
    ...
    <div class="slide-dots">
        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span class="dot"></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php if($banners->isEmpty()): ?><span class="dot"></span><?php endif; ?>
    </div>
</div>
...
<div class="quick-menu">
    <div class="quick-menu-grid">
        <a href="<?php echo e(route('dokter')); ?>" class="quick-menu-item">
            <i class="fas fa-calendar-check"></i>
            <span>Daftar Poliklinik</span>
        </a>
        <a href="<?php echo e(route('dokter.online')); ?>" class="quick-menu-item">
            <i class="fas fa-laptop-medical"></i>
            <span>Layanan Online</span>
        </a>
        <a href="<?php echo e(route('promo')); ?>" class="quick-menu-item">
            <i class="fas fa-tags"></i>
            <span>Paket Promo</span>
        </a>
        <a href="<?php echo e(route('mcu')); ?>" class="quick-menu-item">
            <i class="fas fa-clipboard-check"></i>
            <span>Medical Checkup</span>
        </a>
        <a href="<?php echo e(route('layanan')); ?>" class="quick-menu-item">
            <i class="fas fa-spa"></i>
            <span>Pelayanan Khusus</span>
        </a>
        <a href="<?php echo e(route('home')); ?>" class="quick-menu-item">
...
<section class="py-14 bg-white">
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="flex items-end justify-between mb-8 fade-up">
            ...
            <a href="<?php echo e(route('dokter')); ?>" class="btn-outline-green hidden md:inline-flex flex-shrink-0 ml-8">
                Lihat Semua <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        <div class="flex flex-wrap gap-3 fade-up">
            <?php $__empty_1 = true; $__currentLoopData = $spesialisasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('dokter.by-spesialis', ['spSlug' => $sp->id])); ?>" class="spesialis-pill">
                <i class="fas <?php echo e($sp->icon ?? 'fa-stethoscope'); ?>"></i> <?php echo e($sp->nama_spesialis); ?>
        ...
        <div class="mt-6 md:hidden fade-up">
            <a href="<?php echo e(route('dokter')); ?>" class="btn-outline-green w-full justify-center">
                Lihat Semua <i class="fas fa-arrow-right"></i>
            </a>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <p class="text-green-100 leading-relaxed text-sm mb-6">
                        ...
                        <?php else: ?>
                            Rumah Sakit Sari Sehat berada di Depok dengan motto <strong class="text-white">"<?php echo e($setting->motto ?? 'Melayani dengan Kasih Sayang'); ?>"</strong>, dan senantiasa memberikan mutu pelayanan yang profesional kepada seluruh pasien kami.
                        <?php endif; ?>
                    </p>
                    <a href="<?php echo e(route('tentang')); ?>" class="inline-flex items-center gap-2 bg-white text-green-700 px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-green-50 transition-all shadow-md">
                ...
                <div id="stats-section" class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 border-t lg:border-t-0 lg:border-l border-white/20 py-4 sm:py-0">
                    ...
                    <div class="stat-box w-full sm:w-1/2 flex flex-col items-center justify-center">
                        <i class="fas <?php echo e($ico); ?> text-green-300 text-xl mb-2 block"></i>
                        <div class="stat-number"><?php echo e($val); ?></div>
...
<section class="py-14 bg-gray-50">
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="flex items-end justify-between mb-8 fade-up">
            ...
            <a href="<?php echo e(route('promo')); ?>" class="btn-outline-green hidden md:inline-flex">
                Lihat Semua <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 fade-up">
            ...
            <a href="<?php echo e(route('promo.detail', $promo)); ?>" class="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                <div class="relative flex-shrink-0" style="height:160px; background: linear-gradient(135deg, #00521f, #00b04f)">
                    <?php if($promo->gambar): ?>
                    <img src="<?php echo e(Storage::url($promo->gambar)); ?>" alt="<?php echo e($promo->judul); ?>"
        ...
        <div class="mt-5 md:hidden text-center fade-up">
            <a href="<?php echo e(route('promo')); ?>" class="btn-outline-green">Lihat Semua <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
</section>
...
<section class="py-14 bg-white">
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="flex items-end justify-between mb-8 fade-up">
            ...
            <a href="<?php echo e(route('event')); ?>" class="btn-outline-green hidden md:inline-flex">
                Lihat Semua <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 fade-up">
            ...
            <a href="<?php echo e(route('event.detail', $ev)); ?>" class="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                <div class="relative flex-shrink-0" style="height:160px; background: linear-gradient(135deg,#4c1d95,#7c3aed)">
                    <?php if($ev->gambar): ?>
                    <img src="<?php echo e(Storage::url($ev->gambar)); ?>" alt="<?php echo e($ev->judul); ?>" class="absolute inset-0 w-full h-full object-cover">
                    <?php else: ?>
                    <div class="absolute inset-0 flex items-center justify-center">
                ...
                <div class="flex flex-col flex-1 p-4">
                    ...
                    <p class="text-gray-500 text-xs leading-relaxed line-clamp-2 flex-1">
                        <?php echo e(Str::limit(strip_tags($ev->deskripsi ?? ''), 80)); ?>

                    </p>
                    <div class="flex items-center justify-between mt-3 pt-2 border-t border-gray-100">
                        <?php if($ev->lokasi): ?>
                        <span class="text-xs text-gray-400 truncate max-w-[60%]"><i class="fas fa-location-dot mr-1 text-purple-400"></i><?php echo e($ev->lokasi); ?></span>
                        <?php else: ?>
                        <span class="text-xs text-gray-400"><?php echo e($ev->tanggal_event?->format('d M Y')); ?></span>
                        <?php endif; ?>
...
<section class="py-14 bg-gray-50">
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 fade-up">
            ...
            <a href="<?php echo e(route('informasi.detail', $info)); ?>" class="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                <div class="relative flex-shrink-0" style="height:160px; background:linear-gradient(135deg,#1e3a5f,#0284c7)">
                    <?php if($info->gambar): ?>
                    <img src="<?php echo e(Storage::url($info->gambar)); ?>" alt="<?php echo e($info->judul); ?>" class="absolute inset-0 w-full h-full object-cover">
                    <?php elseif($info->thumbnail): ?>
                    <img src="<?php echo e(Storage::url($info->thumbnail)); ?>" alt="<?php echo e($info->judul); ?>" class="absolute inset-0 w-full h-full object-cover">
                    <?php else: ?>
                    <div class="absolute inset-0 flex items-center justify-center">
                ...
                <div class="flex flex-col flex-1 p-4">
                    <span class="text-gray-400 text-[10px] mb-1.5"><?php echo e($info->created_tm?->format('d M Y')); ?></span>
                    ...
                    <p class="text-gray-500 text-xs leading-relaxed line-clamp-2">
                        <?php echo e(Str::limit(strip_tags($info->isi ?? ''), 80)); ?>
