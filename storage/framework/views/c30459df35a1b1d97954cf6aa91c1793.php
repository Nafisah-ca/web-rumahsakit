...
<section class="py-12 bg-gray-50">
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $informasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('informasi.detail', $info)); ?>"
               class="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all">
                ...
                <div class="relative flex-shrink-0" style="height:180px; background: linear-gradient(135deg,#0c4a6e,#0284c7)">
                    <?php if($info->gambar): ?>
                    <img src="<?php echo e(Storage::url($info->gambar)); ?>" alt="<?php echo e($info->judul); ?>"
                         class="absolute inset-0 w-full h-full object-cover">
                    <?php elseif($info->thumbnail): ?>
                    <img src="<?php echo e(Storage::url($info->thumbnail)); ?>" alt="<?php echo e($info->judul); ?>"
                         class="absolute inset-0 w-full h-full object-cover">
                    <?php else: ?>
        ...
        <div class="mt-10 flex justify-center"><?php echo e($informasis->links()); ?></div>
        <?php endif; ?>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\rumahsakit\resources\views/informasi.blade.php ENDPATH**/ ?>