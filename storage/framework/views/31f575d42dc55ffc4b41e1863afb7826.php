...
<section class="py-14 bg-white">
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
            ...
            <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $telepon)); ?>"
               class="block p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group bg-green-50">
                ...
                <div class="font-extrabold text-gray-900 text-base mb-1"><?php echo e($telepon); ?></div>
            ...
            <a href="mailto:<?php echo e($email); ?>"
               class="block p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all group bg-blue-50">
                ...
                <div class="font-extrabold text-gray-900 text-base mb-1"><?php echo e($email); ?></div>
            ...
            ?>
            <a href="https://wa.me/<?php echo e($waClean); ?>" target="_blank" rel="noopener"
               style="display:block;padding:24px;border-radius:16px;text-align:center;border:1px solid #e5e7eb;box-shadow:0 1px 3px rgba(0,0,0,.08);background:#ecfdf5;text-decoration:none;transition:all .2s">
                ...
                <div style="font-weight:800;color:#111827;font-size:15px;margin-bottom:4px"><?php echo e($waLabel); ?></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div id="guestbook">
                ...
                <form method="POST" action="<?php echo e(route('kontak.store')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="<?php echo e(old('nama')); ?>" required maxlength="255"
                               placeholder="Masukkan nama lengkap Anda"
                               class="w-full px-4 py-2.5 rounded-xl border <?php echo e($errors->has('nama') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all">
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" required
                                   ...
                                   class="w-full px-4 py-2.5 rounded-xl border <?php echo e($errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-1.5">No. HP / WhatsApp</label>
                            <input type="text" name="telepon" value="<?php echo e(old('telepon')); ?>" maxlength="20"
                    ...
                    <div>
                        ...
                        <textarea name="pesan" rows="5" required maxlength="2000"
                                  ...
                                  class="w-full px-4 py-2.5 rounded-xl border <?php echo e($errors->has('pesan') ? 'border-red-400 bg-red-50' : 'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all resize-none"><?php echo e(old('pesan')); ?></textarea>
            ...
            <div>
                ...
                <div class="rounded-2xl overflow-hidden border border-gray-200 shadow-sm mb-5" style="height:280px">
                    <?php if($setting->google_maps): ?>
                    <iframe src="<?php echo e($setting->google_maps); ?>"
                        width="100%" height="280" style="border:0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"
                        title="Peta Lokasi <?php echo e($setting->nama_rumahsakit); ?>">
                    </iframe>
                    <?php else: ?>
                    <iframe
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-3 items-start p-4 rounded-xl bg-gray-50 border border-gray-100">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-bold text-gray-900 text-sm"><?php echo e($setting->nama_rumahsakit); ?></p>
                            <p class="text-gray-500 text-xs mt-0.5"><?php echo e($setting->alamat); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>

                    <?php if($setting->jam_operasional): ?>
                    <div class="flex gap-3 items-start p-4 rounded-xl bg-gray-50 border border-gray-100">
                        <div class="w-9 h-9 rounded-lg bg-green-100 flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-gray-500 text-xs mt-0.5"><?php echo nl2br(e($setting->jam_operasional)); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>

                    <?php if($setting->telepon): ?>
                    <div class="flex gap-3 items-start p-4 rounded-xl bg-gray-50 border border-gray-100">
                        <div class="w-9 h-9 rounded-lg bg-green-100 flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-gray-500 text-xs mt-0.5"><?php echo e($setting->telepon); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex gap-3 items-start p-4 rounded-xl bg-gray-50 border border-gray-100">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-gray-500 text-xs mt-0.5"><?php echo e($setting->email); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>

                    <a href="https://www.google.com/maps/search/<?php echo e(urlencode($setting->alamat ?? 'RS Sari Sehat')); ?>" target="_blank" rel="noopener"
