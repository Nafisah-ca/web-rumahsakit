...
<div class="min-h-screen bg-gray-50 flex items-center justify-center py-16 px-4">
    <div class="w-full max-w-lg">
        <div class="text-center mb-8">
            <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-3 mb-5">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="<?php echo e(route('register.post')); ?>" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required
                            class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('name')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all"
                            placeholder="Sesuai KTP">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1.5">Email <span class="text-red-500">*</span></label>
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required
                            class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('email')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik" value="<?php echo e(old('nik')); ?>" maxlength="16" required
                            class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('nik')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="jenis_kelamin" required class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('jenis_kelamin')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required
                            class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('tanggal_lahir')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all">
                    </div>
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-700 mb-1.5">Tempat Lahir <span class="text-red-500">*</span></label>
                    <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir')); ?>" required maxlength="100"
                        class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('tempat_lahir')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all"
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2" required
                        class="w-full px-4 py-3 rounded-xl border <?php echo e($errors->has('alamat')?'border-red-400 bg-red-50':'border-gray-200'); ?> text-sm focus:border-green-500 focus:ring-2 focus:ring-green-100 outline-none transition-all resize-none"
                        placeholder="Jalan, Nomor, RT/RW, Kelurahan, Kecamatan, Kota"><?php echo e(old('alamat')); ?></textarea>
                </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                <p class="text-gray-500 text-sm">Sudah punya akun?
                    <a href="<?php echo e(route('login')); ?>" class="text-green-600 font-bold hover:text-green-800">Masuk</a>
                </p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\rumahsakit\resources\views/auth/register.blade.php ENDPATH**/ ?>