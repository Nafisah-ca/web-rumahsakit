    ...
    <div class="max-w-screen-xl mx-auto px-4">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 text-sm mt-2 max-w-lg mx-auto">
                Tersedia lebih dari {{ $layananList->count() }} layanan dengan dokter ahli dan peralatan medis terkini.
            </p>
        </div>
                ...
                <div class="p-6">
                    <div class="flex items-start gap-4 mb-4">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-green-50 group-hover:scale-110 transition-transform">
                            <i class="fas {{ $l->icon ?? 'fa-stethoscope' }} text-lg text-green-600"></i>
                        </div>
                        <div>
                            <h3 class="font-extrabold text-gray-900 text-base">{{ $l->nama_layanan }}</h3>
                            <span class="text-xs font-semibold text-gray-400">RS Sari Sehat</span>
                        </div>
                    </div>

                    @if($l->deskripsi)
                    <p class="text-gray-500 text-sm leading-relaxed mb-4">{{ Str::limit($l->deskripsi, 120) }}</p>
                    @endif
    ...
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="card-base p-6 text-center group fade-up">
                ...
                <a href="{{ route('portal.booking.create') }}" class="btn-outline-green text-xs py-2 px-4">
