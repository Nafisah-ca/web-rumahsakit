@extends('layouts.cms')
@php $pageTitle = 'Tambah FAQ'; $breadcrumb = 'CMS / FAQ / Tambah'; @endphp
@section('content')
<div style="max-width:720px">
    ...
    <div class="card">
        <div class="card-header"><h3>Tambah FAQ Baru</h3></div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('cms.faq.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="jawaban" rows="5" class="form-input"
                              placeholder="Tuliskan jawaban lengkap..." required>{{ old('jawaban') }}</textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <p class="form-hint">Angka kecil tampil lebih dahulu. Default: 0</p>
                    </div>
                    <div class="form-group">
