            ...
            <div class="form-row">
                ...
                <div class="form-group" style="grid-column:1/-1">
                    ...
                    <select name="dokter_id" class="form-input">
                        ...
                        <option value="{{ $d->id }}" {{ old('dokter_id', $layanan->dokter_id)==$d->id?'selected':'' }}>{{ $d->nama_dokter }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" style="grid-column:1/-1">
                    ...
                    <textarea name="deskripsi" rows="8" class="form-input">{{ old('deskripsi',$layanan->deskripsi) }}</textarea>
                </div>
