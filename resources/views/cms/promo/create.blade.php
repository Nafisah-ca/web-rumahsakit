        ...
        <form method="POST" action="{{ route('cms.promo.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="thumbnail" class="form-input" accept="image/*" id="thumb-input">
                    <div id="thumb-preview" style="margin-top:8px;display:none"><img id="thumb-img" style="max-height:80px;border-radius:6px"></div>
                </div>
                <div class="form-group" style="grid-column:1/-1">
...
document.getElementById('thumb-input').addEventListener('change', function() {
    const f = this.files[0]; if (!f) return;
    document.getElementById('thumb-img').src = URL.createObjectURL(f);
