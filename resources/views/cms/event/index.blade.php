    ...
    <div class="card-header">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
            <form style="display:flex;gap:8px;flex-wrap:wrap" method="GET">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari event..." class="form-input" style="min-width:120px;flex:1">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:12px;color:#94a3b8;max-width:140px;overflow:hidden;text-overflow:ellipsis">{{ $ev->lokasi ?? '-' }}</td>
