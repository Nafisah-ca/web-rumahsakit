...
@php
    $isOnline = isset($online) && $online;
@endphp

<x-page-hero
    page="dokter"
    :override-judul="$isOnline ? 'Layanan Online' : null"
    :override-label="$isOnline ? 'Layanan Kesehatan Digital' : null"
    :breadcrumbs="[['Beranda','home'],[$isOnline ? 'Layanan Online' : 'Jadwal Dokter', null]]"
/>
