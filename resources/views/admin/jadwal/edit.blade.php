...
<div style="max-width:560px">
    <div class="card card-body">
        <p style="font-size:16px;font-weight:700;color:#0f172a;margin-bottom:4px">Edit Jadwal Mingguan</p>
        ...
        <form method="POST" action="{{ route('admin.jadwal.update', $jadwalDokter) }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="kuota" value="{{ old('kuota',$jadwalDokter->kuota) }}" class="form-input" min="1" max="200" required>
