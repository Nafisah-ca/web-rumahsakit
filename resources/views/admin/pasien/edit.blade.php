...
@php $pageTitle = 'Edit Pasien'; $breadcrumb = 'Admin / Pasien / Edit'; @endphp
@section('content')
<div style="max-width:720px">
    <div class="card card-body">
        <p style="font-size:15px;font-weight:700;color:#0f172a;margin-bottom:20px">
            Edit Pasien: <span style="color:#16a34a">{{ $pasien->user?->nama ?? '-' }}</span>
        </p>
        <form method="POST" action="{{ route('admin.pasien.update', $pasien) }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="nik" value="{{ old('nik',$pasien->nik) }}" class="form-input" maxlength="16" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir',$pasien->tempat_lahir) }}" class="form-input" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Tanggal Lahir <span style="color:#ef4444">*</span></label>
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir',$pasien->tanggal_lahir?->format('Y-m-d')) }}" class="form-input" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pekerjaan" value="{{ old('pekerjaan',$pasien->pekerjaan) }}" class="form-input" placeholder="cth: PNS, Wiraswasta, dll">
                </div>
            </div>

            <div class="form-group">
                <label class="form-label">Alamat Lengkap <span style="color:#ef4444">*</span></label>
                <textarea name="alamat" rows="2" class="form-input" required>{{ old('alamat',$pasien->alamat) }}</textarea>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomor_penjamin" value="{{ old('nomor_penjamin',$pasien->nomor_penjamin) }}" class="form-input" placeholder="No. BPJS / No. Asuransi">
                </div>
            </div>

            <div style="display:flex;gap:10px;margin-top:8px">
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan Perubahan</button>
                <a href="{{ route('admin.pasien.show',$pasien) }}" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
