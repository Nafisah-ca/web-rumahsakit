{{--
    ...
    Props:
      $banner    — instance PageBanner (wajib)
...
@php
    ...
    $heroBg = $banner->gambar
        ? "background: linear-gradient(135deg, {$w1}cc, {$w2}99), url('".Storage::url($banner->gambar)."') center/cover no-repeat;"
